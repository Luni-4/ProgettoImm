...
%%****************************************************************%
% Usiamo questa implementazione come test per i valori di Ix e Iy 
 

function optical_flow_MR();
...
% Qui ho sostituito con le nostre immagini

ORIGINAL_IMAGE_1=imread('images/frame01.jpg');

ORIGINAL_IMAGE_2=imread('images/frame05.jpg');
